export interface IOffice {
  ...
  address: string
  workDays: string
  samplingBioMaterialTime: string
  resultsTime: string
  phone: string
  email?: string
...
const mk1: IOffice = {
  ...
  address:
    'пл.Восставших,4 (Новый бульвар) Центральный корпус, 2 этаж, кабинет №211',
  workDays: 'Понедельник - Пятница',
  samplingBioMaterialTime: '08:00 - 11:30',
  resultsTime: '12:00 - 16:00',
  phone: '+7(978)043-94-47',
  locationForLink:
    'https://www.google.ru/maps/place/4+%D0%BF%D0%BB.+%D0%92%D0%BE%D1%81%D1%81%D1%82%D0%B0%D0%B2%D1%88%D0%B8%D1%85,+%D0%A1%D0%B5%D0%B2%D0%B0%D1%81%D1%82%D0%BE%D0%BF%D0%BE%D0%BB%D1%8C/@44.6009303,33.5127546,17z/data=!3m1!4b1!4m5!3m4!1s0x409524b0a58fc373:0x7ddc6ede6fab73a!8m2!3d44.6009265!4d33.5149433',
  locationForFrame:
