...
export default function AllOfficesInfo(){
	...
	function getInfo(arr: IOffice[]){
		return arr.map((office: IOffice) => {
			return <div className="officeInfo" key={office.id}>
				<div className="officeInfo__text">
					...
					<a href={office.locationForLink} target='_blank' rel="noopener noreferrer"><p>Показать на карте</p></a>
				</div>
				<div className="officeInfo__map">
					<iframe src={office.locationForFrame}
							width="600" height="450" frameBorder="0" style={{'border': '0'}}
							allowFullScreen title={office.header}>
					</iframe>
				</div>
			</div>
		})
