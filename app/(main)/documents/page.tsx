      ...
      >
        <li style={{ marginBottom: '32px' }}>
          ...
          >
            ...
            бесплатного оказания гражданам медицинской помощи в городе
            Севастополе на 2026 год и на плановый период 2027 и 2028 годов
          </a>
        </li>
        <li style={{ marginBottom: '32px' }}>
          <span
            style={{ fontSize: '18px', fontWeight: '500', marginRight: '12px' }}
          >
          ...
          <a href="/politics.docx" download style={{ color: '#0066cc' }}>
            Скачать
          </a>
        </li>
      </ul>
